...
//    DatabaseReference myRef = database.getReference("message");
 //   private final DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://quizapp-29307-default-rtdb.asia-southeast1.firebasedatabase.app/");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child("time").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                final int getQuizTime = snapshot.getValue(Integer.class);
                startQuizTimer(getQuizTime);
                //   Toast.makeText(MainActivity.this, "Connected to get data from Firebase", Toast.LENGTH_SHORT).show();
            }
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MainActivity.this, "Fail to get data from Firebase", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedOption != 0){
                    ...
                    Toast.makeText(MainActivity.this, "Bạn phải chọn câu hỏi trước", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void selectQuestion(int questionListPosition){
        ...
        currentQuestion.setText("Câu hỏi "+(questionListPosition+1));
    }
